...
import { Get_Main ,Get_Main_By_ID,Post_Main } from "../controllers/display/main";
import { Get_Random } from "../controllers/display/random";
import { All , All_Sorted , All_Categories , All_Categories_Names } from '../controllers/display/all';
